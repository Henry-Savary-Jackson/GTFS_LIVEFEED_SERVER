...
from gtfs_rt_server.db_utils import insert_user, password_hasher,delete_user_with_username , modify_user, list_users 
...
@has_roles("admin")
def list_user_endp():
    return [user._asdict() for user in list_users()]
# add
