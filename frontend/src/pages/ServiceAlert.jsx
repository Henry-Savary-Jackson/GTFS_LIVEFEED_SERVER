...
import { RouteSelect, StopSearch, TripSearch } from '../components/search/TripSearch';
import { getHtmlForEntity, getRoutes, convertDateToDateTimeString, getServices, getCauses, getEffects, sendServiceAlert, system_languages, doActionWithAlert, getStops, getStopTimesofTrip, getTripsToRouteID, generate_google_maps_link, get_stops_of_route } from '../utils/RequestUtils';
...
function convertServiceAlertDictToGTFS(dict) {
    ...
    if ("start" in dict && "end" in dict && dict.start >= dict.end){
        throw new Error("The start date must be less than the end date chosen.")
    }
